...
export class Details extends Component {
    state = {
        ...
        socialMediaIcons: {
            ...
            'GitHub': 'https://i.dlpng.com/static/png/6371680_preview.png',
                ...
                { this.state.skillDetails ? 
                    <div className = "grid margin">
                        <div class="container1 grid-item">
                            <span class ="whichSkill">Front-end</span>
                            <br></br>
                        ...
                        <div class="container1 grid-item">
                            <span class ="whichSkill">Back-end</span>
                            <br></br>
                            <CodeIcon fontSize = "large" className = "dummyIcon"></CodeIcon>
                            <div class="overlay">
                                <div class="text">
                        ...
                        <div class="container1 grid-item">
                            <span class ="whichSkill">Strong-suite</span>
                            <br></br>
                            <CodeIcon fontSize = "large" className = "dummyIcon"></CodeIcon>
                            <div class="overlay">
                                <div class="text">
                 ...
                 { this.state.projectDetails?
                    ...
                    <Personal currentVal = {value} object = {this.state.projectObject} icons = {this.state.socialMediaIcons} links = {this.state.myLinks}> </Personal>
                    }</div> )}                  
                </div> : ''
                }
